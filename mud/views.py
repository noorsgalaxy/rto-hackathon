...
def get_info(request):
    ...
    if request.method == 'POST':
        ...
        if all([pdetail.is_valid(), presentadd.is_valid(), permanentadd.is_valid(), vdetails.is_valid()]):
            ...
            return HttpResponseRedirect('userdash/%s/' %(vdetails.chassis_no))
        else:
